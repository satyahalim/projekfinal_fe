(async function loadEventDetail() {
  ...
  try {
    ...
    const res = await fetch(`https://projek-be-559917148272.us-central1.run.app/event/${eventId}`, {
      headers: {
    ...
    document.getElementById("btn-daftar").addEventListener("click", async () => {
      ...
      try {
        const res = await fetch(`https://projek-be-559917148272.us-central1.run.app/register/${eventId}`, {
          method: "POST",
          headers: {
