const API = "https://projek-be-559917148272.us-central1.run.app/regist";
...
async function loadRegistrants() {
  try {
    ...
    const res = await fetch(`https://projek-be-559917148272.us-central1.run.app/registrants/${selectedEventId}`, {
